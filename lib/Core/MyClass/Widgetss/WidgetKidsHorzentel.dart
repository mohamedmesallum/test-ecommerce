...
import 'package:testapi/Data/Model/ModelKids.dart' as ModelKids;
import '../../../Url.dart';
import '../../../controllers/ControllerKids.dart';
import '../../../controllers/ControllerMan.dart';
import 'Widgets.dart';

class listviewKidsH extends StatelessWidget {
  final List<ModelKids.Data> DataGirls;
  final int i;

  listviewKidsH(this.DataGirls,this.i);
      ...
      InkWell(
        onTap: ()async{
          if(await CheckIntrnet()){
            ...
            Get.toNamed('/ViewProdectsKids',arguments: {
              'id':DataGirls[i].id,
