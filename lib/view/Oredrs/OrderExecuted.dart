...
class OrderExecuted extends StatelessWidget {
        ...
        GetBuilder<ControllerHome>(
            ...
            Padding(
              ...
              GetBuilder<ControllerHome>(
                builder: (c)=>
                    ListView.builder(
                        itemCount: c.oredrsss!.receive!.length,
                        itemBuilder:(ctx,i){
                          return
                            Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: InkWell(
                                    onTap: ()async{
                                      await c.GetdattOredrs(idodred:'${c.oredrsss!.receive![i].orderNumber}').then((value) => Get.toNamed('/ShowOrder'));
                                    },
                                    child: Card(
                                      elevation: 7,
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(' ${c.oredrsss!.receive![i].timee}' ,style: TextStyle(fontSize: 18,fontWeight: FontWeight.w900,color: Colors.blueGrey),),
                                              ],
                                            ),
                                            SizedBox(height: 8,),
                                            Row(
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(' ${c.oredrsss!.receive![i].totalpriec}' ,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700,color: Colors.blueGrey),),
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(' Order has been delivered' ,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900,color: Colors.deepOrangeAccent),),
