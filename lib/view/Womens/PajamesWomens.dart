...
class PajamesWomens extends StatelessWidget {
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${w.Womens.pajamas!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (ctx,i){
                                    return
                                      WidgetWomen(w.Womens.pajamas!,i);
