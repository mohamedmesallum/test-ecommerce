...
class ShoesWomens extends StatelessWidget {
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${w.Womens.shoes!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Container(
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (ctx,i)=>
                                  listviewWomens(w.Womens.accessoriesGirls!,i),
