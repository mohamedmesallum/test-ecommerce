...
class  MakeupWomens extends StatelessWidget {
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${w.Womens.makeup!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemCount: w.Womens.makeup!.length,
                                  itemBuilder: (ctx,i){
                                    return
                                      WidgetWomen(w.Womens.makeup!,i);
                          ...
                          Container(
                            ...
                            ListView.builder(
                              ...
                              itemCount:w.Womens.shoes!.length,
                              itemBuilder: (ctx,i)=>
                                  listviewWomens(w.Womens.shoes!,i),
