...
class clothesWomens extends StatelessWidget {
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${w.Womens.data!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Container(
                            ...
                            ListView.builder(
                              ...
                              itemCount:w.Womens.pajamas!.length,
                              itemBuilder: (ctx,i)=>
                                  listviewWomens(w.Womens.pajamas!,i),
