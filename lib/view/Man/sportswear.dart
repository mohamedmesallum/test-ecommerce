...
class Sportswear extends StatelessWidget {
                      ...
                      SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 3,),
                                          Text('${c.Sportswear.data!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                        ],
                                      )
                                    ],
                                  ),
                            ...
                            SizedBox(height: 10,),
                            Text('Watches',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 22,color: Colors.deepOrangeAccent),),
                            // SizedBox(height: 5,),
                            seeALL(ontap: ()async{}),
                            Container(
                              height: 300,
