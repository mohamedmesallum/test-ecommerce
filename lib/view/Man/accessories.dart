    ...
    return Scaffold(
      ...
      body:
         ...
         GetBuilder<ControllerMan>(
           init:ControllerMan(),
           builder:(t)=>
           HindlingDataView(t.statusRequest,
                   ...
                   children: [
                     ...
                     CarouselSlider(
                       options: CarouselOptions(
                           ...
                           autoPlay: true,
                           height: 280.0),
                       items: c.accessories.data!.map((i) {
                         return Builder(
                         ...
                         children: [
                           ...
                           Row(
                             children: [
                               ...
                               SizedBox(width: 3,),
                               Text('${c.accessories.data!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                             ],
                           )
                         ],
                       ),
                 ...
                 Padding(
                   ...
                   child: Container(
                       ...
                       child: GridView.builder(
                         ...
                         itemBuilder: (ctx,i){
                           return
                             WidgetMan(c.accessories.data!,i);
