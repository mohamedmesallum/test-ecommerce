...
class ShoesKids extends StatelessWidget {
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${k.Kids.shoes!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Container(
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (ctx,i)=>
                                  ...
                                  listviewKidsH(k.Kids.accessories!,i),
