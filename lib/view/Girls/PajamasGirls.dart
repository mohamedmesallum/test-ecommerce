...
class PajamasGirls extends StatelessWidget {
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${g.girles.pajamas!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (ctx,i){
                                    return
                                      WidgetGirls(g.girles.pajamas!,i);
                          ...
                          Container(
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (ctx,i)=>
                                  listviewGirlsH(g.girles.data!,i),
