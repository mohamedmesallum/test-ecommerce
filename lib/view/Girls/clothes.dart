...
import 'package:testapi/Core/MyClass/Widgetss/WidgetGirls.dart';
...
class clothesGirls extends StatelessWidget {
          ...
          builder:(g)=>   HindlingDataView(g.statusRequest,
                    ...
                    child: Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${g.girles.data!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemCount: g.girles.data!.length,
                                  itemBuilder: (ctx,i){
                                    return
                                     WidgetGirls(g.girles.data!,i);
                          ...
                          SizedBox(height: 10,),
                         Text('Pajamas',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 22,color: Colors.deepOrangeAccent),),
                                                // SizedBox(height: 5,),
                                                 seeALL(ontap: ()async{}),
                                                 Container(
                                                   height: 300,
                                                  ...
                                                  child:
                                                   ...
                                                   itemCount:g.girles.pajamas!.length,
                                                     itemBuilder: (ctx,i)=>
                                                     listviewGirlsH(g.girles.pajamas!,i),
