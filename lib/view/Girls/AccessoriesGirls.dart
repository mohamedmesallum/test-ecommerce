...
class GirlsAccess extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      GetBuilder<ControllerGirls>(
          ...
          builder:(g)=>
              HindlingDataView(g.statusRequest,
            GetBuilder<ControllerGirls>(
              builder: (g)=>
                          ...
                          children: [
                            ...
                            CarouselSlider(
                              options: CarouselOptions(
                                  ...
                                  autoPlay: true,
                                  height: 280.0),
                              items: g.girles.accessoriesGirls!.map((i) {
                                return Builder(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 3,),
                                      Text('${g.girles.accessoriesGirls!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                    ],
                                  )
                                ],
                              ),
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: GridView.builder(
                                ...
                                itemCount: g.girles.accessoriesGirls!.length,
                                itemBuilder: (ctx,i){
                                  return
                                    WidgetGirls(g.girles.accessoriesGirls!,i);
