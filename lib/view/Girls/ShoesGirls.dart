...
class ShoesGirls extends StatelessWidget {
                    ...
                    SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 3,),
                                        Text('${g.girles.shoes!.length}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.lightBlueAccent),)
                                      ],
                                    )
                                  ],
                                ),
                          ...
                          SizedBox(height: 10,),
                          Text('Makeup',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 22,color: Colors.deepOrangeAccent),),
                          // SizedBox(height: 5,),
                          seeALL(ontap: ()async{}),
                          Container(
                            height: 300,
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (ctx,i)=>
                                  listviewGirlsH(g.girles.makeup!,i),
